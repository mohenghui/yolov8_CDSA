...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/root/autodl-tmp/ultralytics-main/runs/detect/train8/weights/best.engine', help='trained weights path')
    ...
    # model.fuse()
    example_inputs = random_tensor = torch.rand((opt.batch, 3, *opt.imgs)).to(device) 
